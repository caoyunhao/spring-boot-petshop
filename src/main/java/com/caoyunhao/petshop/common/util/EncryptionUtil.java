package com.caoyunhao.petshop.common.util;
...
public class EncryptionUtil {
     ...
     * 密码盐
     */
    private static final String PASSWORD_SALT = "uT3tA$~m*QJzaXG1";

    /**
     * 加密用的盐的基础项，防止对方破解随机数，16位
     */
    private final static String baseSalt = "er()QW!@<}9U*&+m";
    ...
    public static String encryptFrontString(String rawText) {
        ...
        return encrypt((int) Math.ceil(len * len / 10) + rawText + (int) (len * len));
    }
